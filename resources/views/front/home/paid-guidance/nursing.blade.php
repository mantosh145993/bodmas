                ...
                <div class="course-single">
                    <div class="course-single-top">
                        <div class="course-img">
                            <img src="{{asset('assets/img/nursing.jpg')}}" alt="Nursing">
                        ...
                        <ol>
                            ...
                            <li> <strong> Apply on time </strong> and secure your seat through expert counselling.</li>
                        </ol>
                        ...
                        <p>Selecting the wrong college or course can result in losing security deposits, which can be as high as Rs. 2 lac, or even disqualification from future rounds. Our team helps you make the right selections to maximize your chances of securing admission without financial risks.
                        </p>
                        <strong>Preventing Missed Opportunities:</strong>
                        ...
                        <div class="tab-content" id="productTabContent">
                                ...
                                <div class="course-description">
                                    ...
                                    <p style="color: red;"> Registration fees & security deposit (if applicable) will be paid by parent only.
                                        ...
                                        <div class="row">
                                            ...
                                            <h5>Nursing Guidance Fee</h5><p>10,000 INR + GST </p><br>
                            ...
                            <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                <div class="course-curriculam">
                                    ...
                                    <div class="row ">
                                        <div class="col-sm-4 package">
                                        <h5>Pharmacy Guidance Fee</h5><p>10,000 INR + GST </p><br>
                                        <a href="#" class="th-btn style4">Book Now</a>
                                        </div>
                                    </div>
...
<section>
    <div class="container">
        <div class="row">
            ...
            <ol>
                <li><strong>Apply via the Bodmas Paid Guidance Link on our Website:</strong> <p>Use the unique link shared by our career Advisors or visit our official website to apply directly for our services.</p> </li>
