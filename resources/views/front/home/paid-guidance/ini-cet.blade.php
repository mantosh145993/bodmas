                ...
                <div class="course-single">
                    <div class="course-single-top">
                        <div class="course-img">
                            <img src="{{asset('assets/img/ini-cet-landing.png')}}" alt="ini-cet-landing">
                        ...
                        <h2 class="course-title">INI CET Counselling & Guidance Services (2025-26)</h2>
                        <p>The INI CET (Institute of National Importance Combined Entrance Test) is a competitive examination for admission to postgraduate medical courses (MD, MS, DM, MCh) at premier institutions like AIIMS, JIPMER, PGIMER, and NIMHANS. Navigating the INI CET admission process can be complex and stressful, but with the right counseling and guidance, you can secure a seat in your desired program.</p>
                        ...
                        <h3>Available Branches for INI CET:</h3>
                            <ul>
                                <li><strong>MD (Doctor of Medicine):</strong> Anaesthesiology, General Medicine, Pathology, Paediatrics, Psychiatry, Dermatology</li>
                                <li><strong>MS (Master of Surgery):</strong> General Surgery, Orthopaedics, Obstetrics & Gynaecology, Ophthalmology, ENT (Ear, Nose, and Throat)</li>
                                <li><strong>DM (Doctorate of Medicine):</strong> Cardiology, Neurology, Gastroenterology, Nephrology, Endocrinology</li>
                                <li><strong>MCh (Master of Chirurgiae):</strong> Surgical Oncology, Neurosurgery, Urology, Paediatric Surgery</li>
                            </ul>
                    ...
                    <div class="course-img" id="section1">
                        <img src="{{asset('assets/img/bg/INICET.png')}}" alt="INICET Guidance">
                    </div>
                        ...
                        <div class="tab-content" id="productTabContent">
                                ...
                                <div class="course-description">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-6">
                                            ...
                                            <ul>
                                                <li>24/7 Query Support via WhatsApp Messages (Not on Calls).</li>
                                                <li>We will provide counselling for two states.</li>
                                                <li>Complete guidance for hospital selection according to INI CET rank and budget.</li>
                                                ...
                                                <li>Bond Service and Bank Guarantee Details for the relevant state will be discussed and explained in detail.</li>
                                                <li>Detailed College Analysis including Seat Matrix, Clinical Facts, and Fee Structure.</li>
                                                <li>Complete support for DNB-PDCET and home state counselling registration.</li>
                                                <li>Safety of Security Deposit will be our responsibility.</li>
                                                <li>State-wise List of Top Government Hospitals will be provided.</li>
                            ...
                            <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                <div class="course-curriculam">
                                    ...
                                    <del style="color: red;">60,000 INR + GST </del> &nbsp;{{$package->premium_fee}} INR + GST (@18%)</p>
                                    ...
                                    <ul>
                                        ...
                                        <li>Online INI CET Mock Test on the Bodmas Education mobile app.</li>
                                        <li>Previous Year Cutoff Data for government and private hospitals as per your requirement.</li>
                                        <li>Complete guidance for hospital selection according to INI CET rank and budget.</li>
                                        <li>Advice and guidance on all kinds of required certificates like Domicile, Category, Minority, GAP, EWS, Physically Challenged, and NRI.</li>
                                        <li>Bond and Bank Guarantee Details for the relevant state will be discussed and explained in detail.</li>
                                        <li>Detailed College Analysis including Seat Matrix, Clinical Facts, and Fee Structure.</li>
                                        <li>Safety of Security Deposit will be our responsibility.</li>
                                        ...
                                        <li>Merit List and Seat Matrix will be discussed with parents and students during all rounds of counselling.</li>
                                        <li>Choice-Filling Preferences for All Rounds will be done under the guidance of Ashok Sir.</li>
                                        <li>Guidance for Physical Round of Counselling during Mop-Up and Stray Vacancy Rounds.</li>
                                        <li>Refund Policy of Security Deposit will be explained.</li>
                                        <li>Documentation Help at the Time of Reporting at the allotted college will be provided.</li>
                                        <li>Video Meeting with Our Expert Counselor after every round of counselling.</li>
                                        <li>Details Regarding the Least Expensive Options for Management Quota, NRI, and Other Quota Seats.</li>
                                    </ul>
                            ...
                            <div class="tab-pane fade" id="instructor" role="tabpanel" aria-labelledby="instructor-tab">
                                <div class="course-curriculam">
                                    <h6>Bodmas OCI/Foreign/Sponsered  Counselling Package</h6>
                                    <br><br>
                                    <div class="checklist mb-1">
                                    <ul>
                                        <li>Communication via SMS, WhatsApp, Voice Call, Email, and One-to-One Calls.</li>
                                        <li>We will provide counselling for more than two states as per your requirements.</li>
                                        <li>24/7 Alerts for Counselling and Admission-Related Dates and Instructions.</li>
                                        ...
                                        <li>Personalized Counselling Service with a Dedicated Counselor and a 3-Level Support System.</li>
