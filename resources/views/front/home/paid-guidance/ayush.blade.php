                ...
                <div class="course-single">
                    <div class="course-single-top">
                        <div class="course-img">
                            <img src="{{asset('assets/img/ayush.jpg')}}" alt="ayush">
                        ...
                        <div class="tab-content" id="productTabContent">
                            <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                <div class="course-description">
                                    <h6>Bodmas Paid Counselling Guidance Fee For Private Colleges through AACCC (Deemed) / State Counselling For Basic Package</h6>
                                    <p>BAMS/ BHMS/ BUMS /SIDDA/ YOG</p>
                                    <strong><del style="color:red">50,000 INR + GST </del> &nbsp; 20,000 INR + GST (@18%)</strong>
                                    ...
                                    <p style="color: red;"> Registration fees & security deposit (if applicable) will be paid by parent only.
                                        ...
                                        <div class="row">
                                            ...
                                            <h5>Guidance Package Fee</h5><p>20,000 INR + GST </p><br>
                            ...
                            <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                <div class="course-curriculam">
                                    <h6>Bodmas Paid Counselling Guidance Fee For Government Colleges through AIQ / SQ For Premium Package</h6>
                                    <p>BAMS/ BHMS/ BUMS /SIDDA/ YOG</p>

                                    <p><del style="color: red;">50,000 INR + GST </del> &nbsp; 30,000 INR + GST (@18%)</p>
                                    ...
                                    <div class="checklist mb-1">
                                        ...
                                        <p style="color: red;">Note : 10% off on all services for Army/ Police/ siblings / single parent.</p>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4 package">
                                        <h5>Ayush Guidance Package Fee</h5><p>30,000 INR + GST </p><br>
                                        <a href="#" class="th-btn style4">Book Now</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="instructor" role="tabpanel" aria-labelledby="instructor-tab">
                                <div class="course-curriculam">
                                    <h6>Bodmas BAMS Premium Paid Counselling Guidance Fee For NRI Package</h6>
                                    <ol>
                                        <li>Premium Package for NRI/Others/IQ Quota</li>
                                        <li>Private + Government Colleges</li>
                                    </ol>
                                    <p> <del style="color: red;"> 80,0000 INR + GST </del> &nbsp; 50,000 INR + GST (@18%)</p>
                                    <strong>Services Included are:</strong> <br><br>
                                    <div class="checklist mb-1">
                                        <ul>
                                            <li>24/7 Query Support On WhatsApp Messages (Not On Calls)</li>
                                        ...
                                        <div class="row">
                                        <div class="col-sm-4 package">
                                        <h5>Premium Guidance Fee For Ayush</h5><p>50,000 INR + GST </p><br>
                                        <a href="#" class="th-btn style4">Book Now</a>
                                        </div>
                                    </div>
                                    </div>
            ...
            <div class="col-xxl-3 col-lg-4">
                <aside class="sidebar-area">
                    <div class="widget widget_info">
                        ...
                        <span class="h4 course-price">₹20000.00 <span class="tag"></span></span>
