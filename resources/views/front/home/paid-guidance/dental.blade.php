                ...
                <div class="course-single">
                    <div class="course-single-top">
                        <div class="course-img">
                            <img src="{{asset('assets/img/dental.jpg')}}" alt="Dental">
                        ...
                        <div class="tab-content" id="productTabContent">
                            <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                <div class="course-description">
                                    <h6>Bodmas Paid Counselling Guidance Fee For Dental Package</h6>
                                    <ol>
                                        <li> Government Colleges through AIQ / SQ</li>
                                        <li> Private Colleges through MCC (Deemed) / State Counselling </li>
                                    </ol>
                                    <strong><del style="color:red">45,000 INR + GST </del> &nbsp; 30,000 INR + GST (@18%)</strong>
                                    ...
                                    <p style="color: red;"> Registration fees & security deposit (if applicable) will be paid by parent only.
                                        ...
                                        <div class="row">
                                            ...
                                            <h5>Guidance Fee For Dental Package</h5><p>30,000 INR + GST </p><br>
                            ...
                            <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                <div class="course-curriculam">
                                    ...
                                    <p><del style="color: red;">80,000 INR + GST </del> &nbsp; 50,000 INR + GST (@18%)</p>
                                    ...
                                    <div class="row ">
                                        <div class="col-sm-4 package">
                                        <h5>Premium Guidance Fee For Dental</h5><p>50,000 INR + GST </p><br>
                                        <a href="#" class="th-btn style4">Book Now</a>
                                        </div>
                                    </div>
