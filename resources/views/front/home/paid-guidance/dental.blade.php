                ...
                <div class="course-single">
                    <div class="course-single-top">
                        <div class="course-img">
                            <img src="{{asset('assets/img/bds.png')}}" alt="Dental">
                    ...
                    <div class="course-img" id="section1">
                        <img src="{{asset('assets/img/bg/BDS.png')}}" alt="MBBS Guidance">
                    </div>
                        ...
                        <div class="tab-content" id="productTabContent">
                            <div class="tab-pane fade show active" id="Coursedescription" role="tabpanel" aria-labelledby="description-tab">
                                <div class="course-description">
                                    <h6>Bodmas Dental Paid Counselling Guidance Fee For Basic Package</h6>
                                    <ul>
                                    <li> Private Colleges through MCC (Deemed) / State Counselling </li>
                                    </ol>
                                    <strong><del style="color:red">35,000 INR + GST </del> &nbsp; {{$package->basic_fee}} INR + GST (@18%)</strong>
                            ...
                            <div class="tab-pane fade" id="curriculam" role="tabpanel" aria-labelledby="curriculam-tab">
                                <div class="course-curriculam">
                                    <h6>Bodmas Dental Paid Counselling Guidance Fee For Premium Package</h6>
                                    <ul>
                                    <li> <strong> Government Colleges through AIQ / SQ</strong></li>
                                
                                    </ol>
                                    <p><del style="color: red;">40,000 INR + GST </del> &nbsp; {{$package->premium_fee}} INR + GST (@18%)</p>
                            ...
                            <div class="tab-pane fade" id="instructor" role="tabpanel" aria-labelledby="instructor-tab">
                                <div class="course-curriculam">
                                    ...
                                    <p> <del style="color: red;"> 70000 INR + GST </del> &nbsp; {{$package->nri_fee}} INR + GST (@18%)</p>
                                    <strong>Services Included are:</strong> <br><br>
                                    <div class="checklist mb-1">
                                        <ul>
                                            <li>24/7 Query Support On WhatsApp Messages (Not On Calls)</li>
