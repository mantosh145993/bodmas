...
<!-- Home Dynamic slider -->
<div class="responsive-slider-container"> <!-- Added responsive-slider-container class -->
        ...
        <div class="owl-carousel owl-theme home_slider">
            @if($banners && $banners->count() > 0)
                @foreach($banners as $banner)
                    <div class="owl-item">
                        <div>
                            <img src="{{ asset('images/slider_banner/' . $banner->image) }}" alt="{{ $banner->title }}" class="img-fluid">
                        </div>
                    </div>
                @endforeach
            @endif
		...
		<div class="row">
			<div class="col">
				<div class="home_slider_form_container">
					...
					<form action="#" id="home_search_form" class="home_search_form d-flex flex-lg-row flex-column align-items-center justify-content-between">
						<div class="d-flex flex-row align-items-center justify-content-start">
							...
							<select class="dropdown_item_select home_search_input">
								<option>Select UG/PG Type</option>
								<option>UG</option>
								<option>PG</option>
							</select>
							<select class="dropdown_item_select home_search_input">
				...
				<div class="section_title_container text-center mt-5">
					<h2 class="section_title">Welcome to {{ config('app.name') }}</h2>
		...
		<div class="row features_row">
			...
			<div class="col-lg-3 feature_col">
				<div class="feature text-center trans_400">
					<div class="feature_icon"><img src="{{ asset('front/images/icon_1.png') }}" alt=""></div>
			...
			<div class="col-lg-3 feature_col">
				<div class="feature text-center trans_400">
					<div class="feature_icon"><img src="{{ asset('front/images/icon_2.png') }}" alt=""></div>
			...
			<div class="col-lg-3 feature_col">
				<div class="feature text-center trans_400">
					<div class="feature_icon"><img src="{{ asset('front/images/icon_3.png') }}" alt=""></div>
			...
			<div class="col-lg-3 feature_col">
				<div class="feature text-center trans_400">
					<div class="feature_icon"><img src="{{ asset('front/images/icon_4.png') }}" alt=""></div>
	...
	<div class="container">
		...
		<div class="row courses_row">
			...
			<div class="col-lg-4 course_col">
				<div class="course">
					<div class="course_image"><img src="{{ asset('front/images/course_1.jpg')}}" alt=""></div>
			...
			<div class="col-lg-4 course_col">
				<div class="course">
					<div class="course_image"><img src="{{ asset('front/images/course_3.jpg') }}" alt=""></div>
					<div class="course_body">
...
<div class="counter">
	<div class="counter_background" style="background-image:url(images/counter_background.jpg)">

		<img src="{{ asset('front/images/counter_background.jpg') }}" alt="Slider Image" style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;background-repeat: no-repeat;background-size: cover;background-position: center center;">
	</div>
	<div class="container">
		<div class="row">
			<div class="col-lg-6">
		...
		<div class="row events_row">
			...
			<div class="col-lg-4 event_col">
				<div class="event event_left">
					<div class="event_image"><img src="{{ asset('front/images/event_1.jpg') }}" alt=""></div>
			...
			<div class="col-lg-4 event_col">
				<div class="event event_mid">
					<div class="event_image"><img src="{{ asset('front/images/event_2.jpg') }}" alt=""></div>
					<div class="event_body d-flex flex-row align-items-start justify-content-start">
						<div class="event_date">
							<div class="d-flex flex-column align-items-center justify-content-center trans_200">
			...
			<div class="col-lg-4 event_col">
				<div class="event event_right">
					<div class="event_image"><img src="{{ asset('front/images/event_3.jpg') }}" alt=""></div>
					<div class="event_body d-flex flex-row align-items-start justify-content-start">
						<div class="event_date">
							<div class="d-flex flex-column align-items-center justify-content-center trans_200">
	...
	<div class="container">
		...
		<div class="row team_row">
			...
			<div class="col-lg-3 col-md-6 team_col">
				<div class="team_item">
					<div class="team_image"><img src="{{ asset('front/images/team_1.jpg')}}" alt=""></div>
					<div class="team_body">
			...
			<div class="col-lg-3 col-md-6 team_col">
				<div class="team_item">
					<div class="team_image"><img src="{{ asset('front/images/team_2.jpg') }}" alt=""></div>
					<div class="team_body">
			...
			<div class="col-lg-3 col-md-6 team_col">
				<div class="team_item">
					<div class="team_image"><img src="{{ asset('front/images/team_3.jpg') }}" alt=""></div>
					<div class="team_body">
			...
			<div class="col-lg-3 col-md-6 team_col">
				<div class="team_item">
					<div class="team_image"><img src="{{ asset('front/images/team_4.jpg') }}" alt=""></div>
					<div class="team_body">
			...
			<div class="col-lg-7 news_col">
				...
				<div class="news_post_large_container">
					<div class="news_post_large">
						<div class="news_post_image"><img src="{{ asset('front/images/news_1.jpg')}}" alt=""></div>
...
<div class="newsletter">
	<div class="newsletter_background parallax-window" data-parallax="scroll" data-image-src="{{ asset('front/images/newsletter.jpg')}}" data-speed="0.8"></div>
	<div class="container">
		<div class="row">
			<div class="col">
...
<script>
    $(document).ready(function(){
        $('.home_slider').owlCarousel({
            ...
            nav: true,
            navText: [
                $('.home_slider_prev').html(), 
                $('.home_slider_next').html()
            ],
...
.responsive-slider-container {
    width: 100%;
    max-width: auto; /* You can adjust this max-width according to your design */
...
.responsive-slider-container .owl-carousel .owl-item img {
    width: 100%;
...
/* Default styles for .home_slider */
.home_slider {
    width: 100%;
    height: 699px; /* Default height */
}
...
@media (max-width: 1024px) {
    ...
    .home_slider_nav {
        font-size: 16px; /* Adjust font size of navigation icons */
    }
}
...
@media (max-width: 768px) {
    ...
    .home_slider_nav {
        display: block; /* Ensure navigation is visible on smaller screens */
        font-size: 14px; /* Further reduce font size for navigation */
        padding: 10px; /* Adjust padding */
    }

    /* Optional: Adjust visibility or layout for carousel items */
...
@media (max-width: 480px) {
    ...
    .home_slider_nav {
        display: block; /* Ensure navigation remains accessible */
