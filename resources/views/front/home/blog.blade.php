                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                ...
                                <a href="blog.html"><i class="fa-light fa-clock"></i>05 June, 2023</a>
                                <a href="blog-details.html"><i class="fa-light fa-book"></i>Business Analysis</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.html">Educate, Empower, Excel: Discover the Power of Learning!</a>
                            </h2>
                    ...
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                ...
                                <a href="blog.html"><i class="fa-light fa-calendar-days"></i>22 June, 2023</a>
                                <a href="blog-details.html"><i class="fa-light fa-book"></i>Business Analysis</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.html">Enrich Your Mind Envision Your Future Education for Success</a>
                            </h2>
                            <p class="blog-text">Embrace the world of online education with our resources on virtual classrooms, e-learning platforms, and MOOCs (Massive Open Online Courses). Learn how to navigate online courses effectively and make the most of digital learning tools.Discover a curated list of educational apps.</p>
                            <a href="blog-details.html" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="th-blog blog-single">
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html"><i class="far fa-user"></i>by David Smith</a>
                                <a href="blog.html"><i class="fa-light fa-calendar-days"></i>24 June, 2023</a>
                                <a href="blog-details.html"><i class="fa-light fa-book"></i>Business Analysis</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.html">Gain insights into how parents can support childs Education at home</a>
                            </h2>
                            <p class="blog-text">Access a range of teaching strategies, lesson plans, classroom management techniques, and assessment methods for educators. Stay updated on the latest trends and best practices in education. Explore profiles of professionals in various fields to gain insights into their experiences and career journeys.</p>
                            <a href="blog-details.html" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.html"><i class="far fa-user"></i>by David Smith</a>
                                <a href="blog.html"><i class="fa-light fa-calendar-days"></i>28 June, 2023</a>
                                <a href="blog-details.html"><i class="fa-light fa-book"></i>Business Analysis</a>
                            </div>
                            <h2 class="blog-title"><a href="blog-details.html">University class starting soon while the lovely valley team work</a>
                            </h2>
                            <p class="blog-text">Explore our collection of articles, tutorials, videos, and interactive tools to enhance your knowledge and foster a love for learning. Get valuable tips on preparing for exams, including creating study schedules, practicing past papers, managing exam anxiety, and optimizing your performance on test day.</p>
                            <a href="blog-details.html" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            ...
                            <h2 class="blog-title"><a href="blog-details.html"> Learn how to take comprehensive and organized notes to enhance your study</a>
                            </h2>
                            <p class="blog-text">Get valuable tips on preparing for exams, including creating study schedules, practicing past papers, managing exam anxiety, and optimizing your performance on test day. Dive into the fascinating world of science with articles, videos, and experiments covering subjects like biology, chemistry.</p>
                            <a href="blog-details.html" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
