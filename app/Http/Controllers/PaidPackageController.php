...
class PaidPackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        PaidPackage::create([
            ...
            'premium_fee' => $request->input('premium_fee'),
            'nri_fee' => $request->input('nri_fee'),
            'first_installment' => $request->input('first_installment'),
            'second_installment' => $request->input('second_installment'),
            'first_installment_premium' => $request->input('first_installment_premium'),
            'second_installment_premium' => $request->input('second_installment_premium'),
